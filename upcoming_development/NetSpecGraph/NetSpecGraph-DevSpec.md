...
**Implementation branch:** `feat/netspecgraph` — step 1 scaffolding in progress (VM + Telegraf output + binary skeleton). Bring-up: [`docs/NETSPECGRAPH.md`](../../docs/NETSPECGRAPH.md).
